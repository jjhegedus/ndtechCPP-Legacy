...
namespace ndtech
{
    ...
    public:
        SpatialInputHandler();
        ~SpatialInputHandler();
        SpatialInputHandler(const SpatialInputHandler&) = delete;
        SpatialInputHandler& operator=(const SpatialInputHandler&) & = delete;
        SpatialInputHandler(SpatialInputHandler&&) = delete;
        SpatialInputHandler& operator=(SpatialInputHandler&&) & = delete;
