...
#define ISBITMASK( r,g,b,a ) ( ddpf.RBitMask == r && ddpf.GBitMask == g && ddpf.BBitMask == b && ddpf.ABitMask == a )
    ...
    _Use_decl_annotations_
        HRESULT ndtech::CreateDDSTextureFromMemory(ID3D11Device* d3dDevice,
    ...
    _Use_decl_annotations_
        HRESULT ndtech::CreateDDSTextureFromMemoryEx(ID3D11Device* d3dDevice,
            const uint8_t* ddsData,
            size_t ddsDataSize,
            size_t maxsize,
            D3D11_USAGE usage,
    ...
    //--------------------------------------------------------------------------------------
    _Use_decl_annotations_
        HRESULT ndtech::CreateDDSTextureFromFile(ID3D11Device* d3dDevice,
    ...
    _Use_decl_annotations_
        HRESULT ndtech::CreateDDSTextureFromFileEx(ID3D11Device* d3dDevice,
            const wchar_t* fileName,
            size_t maxsize,
            D3D11_USAGE usage,
            unsigned int bindFlags,
